# Legacy AGENTS Baseline (User-supplied)

This is the complete source baseline that was provided for DLens. It is retained so requirements are not lost during restructuring.
